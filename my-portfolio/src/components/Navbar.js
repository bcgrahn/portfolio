                    ...
                    <div className="">
                        <ul class="primary-navigation hamGlassCard ">
                            <li className="p-1 pt-4">
                                <a href="#home" className="text-sm block py-1 pl-3 pr-4 text-gray-200 rounded hover:bg-gray-100">
                            ...
                            <li className="p-1">
                                <a href="#skills" className="text-sm block py-1 pl-3 pr-4 text-gray-200 rounded hover:bg-gray-100">
                            ...
                            <li className="p-1">
                                <a href="#honors" className="text-sm block py-1 pl-3 pr-4 text-gray-200 rounded hover:bg-gray-100">
                            ...
                            <li className="p-1">
                                <a href="#certs" className="text-sm block py-1 pl-3 pr-4 text-gray-200 rounded hover:bg-gray-100">
