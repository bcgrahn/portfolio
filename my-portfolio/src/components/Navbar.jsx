            ...
            <nav class="">
                <div class="navGlassCard">
                    <div className="flex justify-between items-center text-white">
                        ...
                        <button onClick={toggleDiv} type="button" class="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-solid-bg" aria-expanded="false">
